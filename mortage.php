    ...
    <form method="GET" name="information" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <table cellpadding="2" cellspacing="0" border="0" width="100%">
            ...
            <tr valign="top" bgcolor="#eeeeee">
                ...
                <td><input type="checkbox" name="show_progress" value="1" <?php if ($show_progress) {
                                                                                print("checked");
                                                                            } ?>>
            ...
            <tr valign="top" bgcolor="#eeeeee">
                ...
                <td><input type="submit" value="Calculate"><br>
                    <?php if ($form_complete) {
                        print("<a href=\"" . $_SERVER['PHP_SELF'] . "\">Start Over</a><br>");
                    } ?><br></td>
            </tr>
            <?php
            ...
            ?>
                <tr valign="top">
                    <td align="center" colspan="2" bgcolor="#000000">
                        <font color="#ffffff"><b>Mortgage Payment Information</b></font>
                    </td>
                </tr>
                <tr valign="top" bgcolor="#eeeeee">
                ...
                <tr valign="top" bgcolor="#cccccc">
                    ...
                    <td><b><?php echo "\$" . number_format($monthly_payment, "2", ".", ","); ?></b><br>
                        <font>(Principal &amp; Interest ONLY)</font>
                    </td>
                </tr>
                <?php
                if ($down_percent < 20) {
                ...
                ?>
                    ...
                    <tr valign="top" bgcolor="#FFFF99">
                        <td align="right">Monthly Payment:</td>
                        <td><b><?php echo "\$" . number_format(($monthly_payment + $pmi_per_month), "2", ".", ","); ?></b><br>
                            <font>
                ...
                <tr valign="top" bgcolor="#9999FF">
                    ...
                    <td><b><?php echo "\$" . number_format(($monthly_payment + $pmi_per_month + $residential_monthly_tax), "2", ".", ","); ?></b><br>
                        <font>
                            (including <?php echo $pmi_text; ?> residential tax)</font>
                    </td>
                </tr>
            <?php
            }
